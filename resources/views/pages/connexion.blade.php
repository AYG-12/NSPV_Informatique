    ...
    <main class="right">
        ...
        <div class="auth-box">
            ...
            <div class="form-panel active" id="panel-login">
                ...
                @if ($errors->has('email') && old('_form', 'login') === 'login')
                    <div class="alert error" style="display:block">{{ $errors->first('email') }}</div>
                @else
            ...
            <div class="form-panel" id="panel-register">
                ...
                <p class="form-sub">Rejoignez la communauté {{ $appSettings['shop_name'] ?? 'NSPV Informatique' }}.</p>
